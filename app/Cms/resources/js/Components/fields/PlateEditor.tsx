...
import { FixedToolbar } from '@cms/Components/plate-ui/fixed-toolbar';
...
import { FixedToolbarButtons } from '@cms/Components/plate-ui/fixed-toolbar-buttons';
...
const PlateEditor = forwardRef<HTMLInputElement, PlateEditorProps>(({
    label,
    error,
    required = true,
    disabled = false,
    ...
    return (
        <div className={cn({
            ...
            <Plate plugins={plugins} onChange={props.onChange} initialValue={props.value} value={props.value}>
                <FixedToolbar>
                    <FixedToolbarButtons />
                </FixedToolbar>

                <Editor ref={ref} value={props.value} required={required} disabled={disabled} />
            </Plate>
            {description && (
