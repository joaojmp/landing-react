                                    ...
                                    {object.image && (
                                        <Card className="mt-2 h-fit">
                                            ...
                                            <CardContent className='text-center'>
                                                <img src={`/storage/landings/${object.image}`} alt="Imagem de compartilhamento" width={1200} height={630} className="mt-4 mx-auto" /><br />
                                ...
                                <div className="space-y-6">
                                    {object.favicon && (
                                        <Card className="mt-2 h-fit">
                                            ...
                                            <CardContent className='text-center'>
                                                <img src={`/storage/landings/${object.favicon}`} alt="Ícone da página" width={48} height={48} className="mt-4 mx-auto" /><br />
                                                <div className="text-center">
                                                    <AlertDialog>
                                                        <AlertDialogTrigger asChild>
                                                            <Button variant="destructive">
