...
export default function Update({ object }: { object: Banner }) {
    const [cropper, setCropper] = useState<ExternalCropperProps>({ field: "", src: "", width: 1, height: 1 });
    const { data, setData, put, processing, errors, reset } = useForm({
        title: object.title,
        link: object.link,
        desktop: '',
        old_desktop: object.desktop,
        tablet: '',
        old_tablet: object.tablet,
        mobile: '',
        old_mobile: object.mobile,
    } as Banner);

    const submit: FormEventHandler = (e) => {
        e.preventDefault();

        put(route('banners.update', { 'id': object.id }), {
            onSuccess: () => {
                toast({
                    title: "Sucesso.",
    ...
    return (
        <>
            ...
            <section>
                <Card>
                    <CardHeader>
                        <h2 className="text-xl font-bold">Banner cadastrado</h2>
                            ...
                            <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-5">
                                {object.desktop && (
                                    <Card className="mt-2 h-fit">
                                        ...
                                        <CardContent>
                                            <img src={`/storage/banners/${object.desktop}`} alt="Banner desktop" width={1920} height={700} className="mt-4 mx-auto w-full h-auto" />
                                        </CardContent>
                                    </Card>
                                )}
                                {object.tablet && (
                                    <Card className="mt-2 h-fit">
                                        ...
                                        <CardContent className='text-center'>
                                            <img src={`/storage/banners/${object.tablet}`} alt="Banner tablet" width={768} height={300} className="mt-4 mx-auto w-full h-auto" /><br />
                                            <div className="text-center">
                                                <AlertDialog>
                                                    <AlertDialogTrigger asChild>
                                                        <Button variant="destructive">
                                                            <FaTimes className="text-lg cursor-pointer me-1" /> Remover banner tablet
                                                        </Button>
                                                    </AlertDialogTrigger>
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                Essa ação não pode ser desfeita, isso excluirá permanentemente o banner tablet
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction
                                                                onClick={() => {
                                                                    put(route('banners.file', { id: object.id, file: 'tablet' }), {
                                                                        onSuccess: () => {
                                                                            toast({
                                                                                title: "Sucesso.",
                                                                                description: "Banner tablet removido com sucesso!",
                                                                            });
                                                                        }, onError: (errors) => {
                                                                            toast({
                                                                                title: "Ah! algo deu errado.",
                                ...
                                {object.mobile && (
                                    <Card className="mt-2 h-fit">
                                        ...
                                        <CardContent className='text-center'>
                                            <img src={`/storage/banners/${object.mobile}`} alt="Banner mobile" width={425} height={500} className="mt-4 mx-auto max-w-full h-auto" /><br />
                                            <div className="text-center">
                                                <AlertDialog>
                                                    <AlertDialogTrigger asChild>
                                                        <Button variant="destructive">
                                                            <FaTimes className="text-lg cursor-pointer me-1" /> Remover banner mobile
                                                        </Button>
                                                    </AlertDialogTrigger>
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            <AlertDialogTitle>Você tem certeza absoluta?</AlertDialogTitle>
                                                            <AlertDialogDescription>
                                                                Essa ação não pode ser desfeita, isso excluirá permanentemente o banner mobile
                                                                e removerá os dados de nossos servidores.
                                                            </AlertDialogDescription>
                                                        </AlertDialogHeader>
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction
                                                                onClick={() => {
                                                                    put(route('banners.file', { id: object.id, file: 'mobile' }), {
                                                                        onSuccess: () => {
                                                                            toast({
                                                                                title: "Sucesso.",
                                                                                description: "Banner mobile removido com sucesso!",
                                                                            });
                                                                        }, onError: (errors) => {
                                                                            toast({
                                                                                title: "Ah! algo deu errado.",
